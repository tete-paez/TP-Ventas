...
const aceptarEdicionModalEditarVenta = document.getElementById(
  "aceptarEdicionEnModalEditarVenta"
); // boton aceptar editar la venta y guardaro

const todosLosBotonesEditarVenta = document.querySelectorAll(
  ".editarVentaParaModal"
); // clase del boton editar venta => todos los botones
const todosLosBotonesEliminarVenta = document.querySelectorAll(
...
const abrirModalEditarVenta = () => {
  for (const botonEditarVenta of todosLosBotonesEditarVenta) {
    botonEditarVenta.addEventListener("click", () => {
      ...
      aceptarEdicionModalEditarVenta.setAttribute(
        "idDEEditarVenta",
        idBotonEditarVenta
      );
    });
...
const aceptoLaEdicionDeLaNuevaVenta = document.getElementById(
  "aceptarEdicionEnModalEditarVenta"
); // id boton tick de "acepto la edicion de esta venta"
...
aceptoLaEdicionDeLaNuevaVenta.addEventListener("click", (e) => {
  ...
  ventas.forEach((venta, index) => {
    if (
      index == aceptoLaEdicionDeLaNuevaVenta.getAttribute("idDEEditarVenta")
    ) {
